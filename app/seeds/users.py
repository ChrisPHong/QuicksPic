...
def seed_users():
    ...
    uki = User(
        ...
        email='uki@aa.io',
        password='password',
        image='https://quickspic.s3.amazonaws.com/75aef85ce7f24edd89c6d6d2828c2be0.jpg',
        bio='',
        name ='Uki-a/A',
        website='',
    ...
    danny = User(
        ...
        email='danny@aa.io',
        password='password',
        image='https://quickspic.s3.amazonaws.com/6aa339d133264304af3f292818842c01.png',
        bio='',
        name ='Danny-a/A',
        website='',
