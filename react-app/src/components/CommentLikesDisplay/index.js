...
import './CommentLikesDisplay.css';

function CommentDisplayLikesPage({ likes }) {
    ...
    return (
        ...
        {likes.length < 1 ?
        <>
        <div className='likes-h3-title adding-padding'>There are no likes for this comment. . .</div>
...
export default CommentDisplayLikesPage;
